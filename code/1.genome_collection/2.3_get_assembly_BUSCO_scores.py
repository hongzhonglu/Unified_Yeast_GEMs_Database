...
input_dir = r'/lustre/home/acct-clslhz/clslhz/why_ssGEMs/result/check_assembly_completeness/1900_assemblies_BUSCO_results/'
os.chdir(input_dir)

busco_results=open('../1900_assembly_busco_scores.txt','w')
...
for name in os.listdir(input_dir):
    ...
    for line in fhand.readlines():
        ...
        GenomeName=name.replace('short_summary.specific.saccharomycetes_odb10.','').replace('.fna.out.txt','')
