...
# collect each gene family's TPM value in each strains
...
pan1011_geneList=[g.id for g in SeqIO.parse("data/genome/pan1011_v1.fasta","fasta")]
...
all_strain_info.set_index('ssGEM',inplace=True)
